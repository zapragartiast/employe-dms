...
class TestAuthBluePrint(BaseTestCase):
    ...
    def test_registered_user_login(self):
        ...
        with self.client:
            ...
            data = json.loads(response.data.decode())
            self.assertTrue(data['status'] == 'success')
            self.assertTrue(data['message'] == 'Berhasil login.')
            self.assertTrue(data['auth_token'])
            self.assertTrue(response.content_type == 'application/json')
    ...
    def test_non_registered_user_login(self):
        ...
        with self.client:
            ...
            data = json.loads(response.data.decode())
            self.assertTrue(data['status'] == 'fail')
            self.assertTrue(data['message'] == 'Pengguna tidak ditemukan.')
            self.assertTrue(response.content_type == 'application/json')
    ...
    def test_valid_logout(self):
        ...
        with self.client:
            ...
            self.assertTrue(data_login['message'] == 'Berhasil login.')
    ...
    def test_get_detail_pegawai(self):
        ...
        with self.client:
            ...
            self.assertTrue(data_log['message'] == 'Berhasil login.')
